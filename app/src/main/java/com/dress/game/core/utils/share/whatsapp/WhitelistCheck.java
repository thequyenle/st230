...
import com.dress.game.core.utils.share.whatsapp.StickerContentProvider;

@SuppressWarnings("FieldCanBeLocal")
public class WhitelistCheck {
    public static final String CONTENT_PROVIDER_AUTHORITY = "com.dress.game.core.utils.share.whatsapp.StickerContentProvider";
